...
@task(
    name="log_user_query",
    description="Log a user query for analytics and history tracking",
    timeout_seconds=5.0
)
def log_user_query(
    query: str,
...
@task(
    name="format_response_with_sources",
    description="Format a response with source citations in specified format",
    timeout_seconds=5.0
)
...
@task(
    ...
    description="Create a suggested learning path for a topic with defined levels",
...
@task(
    name="validate_query",
    description="Validate a user query before processing with length and content checks",
    timeout_seconds=5.0
)
def validate_query(
    query: str,
...
@task(
    name="build_prompt",
    description="Build a complete prompt with context for the AI model",
    timeout_seconds=10.0
)
def build_prompt(
    query: str,
